...
(
	...
	'text_rule_four_seven' => "&nbsp;&nbsp;&nbsp;&nbsp;5）如果以前上传的字幕时间轴有不对的，你上传的字幕时proper（正确版本）或re-synced（重新校对）的字幕，请在字幕文件末尾添加[PROPER]或[R3]。示例：One.Night.In.Taipei.2015.BluRay.720p.DD5.1.x264-NexusPHP.chs[PROPER]",
