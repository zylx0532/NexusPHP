...
(
	...
	'text_rule_four_one' => "示例：One.Night.In.Taipei.2015.BluRay.720p.DD5.1.x264-NexusPHP.chs",
	...
	'text_rule_four_seven' => "&nbsp;&nbsp;&nbsp;&nbsp;5）如果以前上傳的字幕時間軸有不對的，你上傳的字幕時proper（正確版本）或re-synced（重新校對）的字幕，請在字幕檔末尾添加[PROPER]或[R3]。示例：One.Night.In.Taipei.2015.BluRay.720p.DD5.1.x264-NexusPHP.chs[PROPER]",
