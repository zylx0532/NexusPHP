...
elseif ($action == 'bonussettings'){
	...
	tr($lang_settings['row_hundred_gb_credit'],$lang_settings['text_it_costs_user']."<input type='text' style=\"width: 50px\" name=hundredgbdownload value='".(isset($BONUS["hundredgbdownload"]) ? $BONUS["hundredgbdownload"] : 10000 )."'>".$lang_settings['text_hundred_gb_credit_note'], 1);
