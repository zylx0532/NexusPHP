...
<title>UPUPW PHP探针-安全版</title>
<meta name="keywords" content="php探针,upupw探针,PHP探针安全版,php7探针,phpinfo,php扩展,数据库连接测试" />
<meta name="description" content="upupw php探针安全版兼容最新php7,需成功测试连接本地数据库后才显示phpinfo动态链接页面和网站路径,适用于windows和linux系统." />
...
<td class="fl"><?php if(isset($_POST['act'])) {?>
<?=(@mysqli_select_db($link, $_POST['mysqlDb']))?"<a target='_blank' href='?$pinfo=phpinfo'>PHPINFO详细信息</a>":"<span style='color:red'>数据库连接测试错误拒绝显示</span>"?>
<?php }
else echo "<span style='color:green'>数据库连接测试成功后显示</span>";
?>
</td>
...
<td class="fc"><?=get_extension_funcs('XCache') ? YES : NO ?></td>
